...
Reliance_Pickle = Reliance_Pickle.loc[(Reliance_Pickle['Type']=="CE")]

df=Reliance_Pickle



Reliance_Pickle123 = Reliance_Pickle123.loc[(Reliance_Pickle123['Type']=="CE")]
    ...
    try:
        ...
        if(trend_direction==""):
            ...
            if(i==1 or ((df_drop_datframe['Close_FUT'].iloc[i] <= df_drop_datframe['Close_FUT'].iloc[i-1]) and \
                        (((bracket_low) - df_drop_datframe['Close_FUT'].iloc[i]) <=(int(box_size_entry)*int(box_reversal))))):  
...
# =============================================================================
                ...
                df_drop_datframe.set_value(i, 'Position', "Short")
        ...
        elif(trend_direction=="downward" and df_drop_datframe['Close_FUT'].iloc[i] != df_drop_datframe['Close_FUT'].iloc[i-1]):
...
# =============================================================================
                    ...
                    df_drop_datframe.set_value(i+1, 'Brick', (str(no_of_brick)+"dn"))
                    ...
                    df_drop_datframe.set_value(i+1, 'Position', "Short")
                    df_drop_datframe.set_value(i+1, 'entry_price', entry_price)
                   
        
                    i=i+1 
                
            elif((df_drop_datframe['Close_FUT'].iloc[i] - (bracket_high)) >= int(box_size)*int(box_reversal)):
...
# =============================================================================
                ...
                if(df_drop_datframe['Close_FUT'].iloc[i] < bracket_low):
                    ...
                    if(int((bracket_low-df_drop_datframe['Close_FUT'].iloc[i])/int(box_size))>=1):
                        
                        no_of_brick=int((bracket_low - df_drop_datframe['Close_FUT'].iloc[i])/int(box_size))
                        left_price = ((bracket_low - df_drop_datframe['Close_FUT'].iloc[i])%int(box_size))
                        
                        if(entry_price_future-df_drop_datframe['Close_FUT'].iloc[i]>=\
...
# =============================================================================
        ...
        df_drop_datframe.to_csv('C://Users//admin//Desktop//FNO//renkowithpickelshortcashtoday.csv')
