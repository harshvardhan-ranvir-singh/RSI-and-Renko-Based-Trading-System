...
contracts = []
u = Upstox('aocg0mAF6R2uotb5Mae4Q1PyBBlznq6i7EakN5Dc', '69066ddd8e22cb9b64138af219bf897731310b8b')
d = u.get_master_contract('NSE_FO') # get contracts for MCX FO

# =============================================================================
# for k, v in d.items():
#     if 'banknifty19sep' in v[3:5][0]:
#         contracts.append(v[3:5][0])
# =============================================================================
    
# =============================================================================
# for k, v in d.items():
#     if 'crudeoil' in v[3:5][0]:
#         contracts.append(v[3:5][0])
# =============================================================================
